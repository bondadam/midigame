(function(root, factory){
	...
	Module(function (Tone) {
	    ...
	    Tone.WebAudioFontInstrument = function (url, tone) {
	        this.webAudioFontInstrument = null;
	        this.webAudioFontPlayer = new WebAudioFontPlayer();
	        this.loadInstrument(url, tone);
	        //this.loadInstrument('https://surikov.github.io/webaudiofontdata/sound/0180_GeneralUserGS_sf2_file.js', '_tone_0180_GeneralUserGS_sf2_file');
	    };
	    Tone.WebAudioFontInstrument.defaults = {};
	    Tone.WebAudioFontInstrument.prototype.toMaster = function () {
	        return this;
	    };
	    Tone.WebAudioFontInstrument.prototype.triggerAttack = function (note, time, velocity) {
	        this.envelope = this.webAudioFontPlayer.queueWaveTable(Tone.context, Tone.Master, this.webAudioFontInstrument, 0, Tone.Frequency(note).toMidi(), 987654321);
	        return this;
	    };
	    Tone.WebAudioFontInstrument.prototype.triggerAttackRelease = function (note, time, velocity, duration) {
	        this.envelope = this.webAudioFontPlayer.queueWaveTable(Tone.context, Tone.Master, this.webAudioFontInstrument, 0, Tone.Frequency(note).toMidi(), duration, velocity);
	        return this;
	    };
	    Tone.WebAudioFontInstrument.prototype.triggerRelease = function (time) {
	        if (this.envelope) {
	            this.envelope.cancel();
	            this.envelope = null;
	        }
	    };
	    Tone.WebAudioFontInstrument.prototype.dispose = function () {
	        return this;
	    };
	    Tone.WebAudioFontInstrument.prototype.loadInstrument = function (fileURL, variableName) {
	        var me = this;
	        this.webAudioFontPlayer.loader.startLoad(Tone.context, fileURL, variableName);
	        this.webAudioFontPlayer.loader.waitLoad(function () {
	            me.webAudioFontInstrument = window[variableName];
	        });
	        return this;
	    };
	    return Tone.WebAudioFontInstrument;
	});
	Module(function (Tone) {
	    if (Tone.supported) {
